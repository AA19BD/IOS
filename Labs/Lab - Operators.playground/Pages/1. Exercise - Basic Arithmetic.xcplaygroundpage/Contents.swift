...
print("The result is type of double than integer")
/*:
...
let odd=11
print(even%2,odd%2)
print("Knowing the remainder,we can determine if an integer is even if remainder==0 or odd if remainder==1")
