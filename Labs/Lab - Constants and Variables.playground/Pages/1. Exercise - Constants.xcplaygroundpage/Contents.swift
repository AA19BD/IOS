 ...
 */
print("No,because we cannot assign to value: 'friends' is a 'let' constant.We using let when we want to name a value that won’t change during the lifetime of the program, we’ll use a constant.We simply can not give the new value after assigning it!")
